...
if __name__=="__main__":
    # txt = read_files("/home/ayoub/DS/Parser-Shortlisting-Project/files/resumes") old***
    txt = read_files("C:/Users/Dell/AppData/Local/Programs/PythonPython310/final_parser/files/resumes")
    print(txt)